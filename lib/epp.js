...
EPP.prototype.createDomain = function(data, transactionId) {
    var config = this.config;
    var domainNamespace = config.namespaces.domain;
    //var contacts = data.contact; // this.processDomainContacts(data.contact);
    var nsHostObjects = data.ns; //this.processDomainNS(data.ns);
...
EPP.prototype.createContact = function(data, transactionId) {
    console.log('EPP.prototype.createContact', data);
    var config = this.config;
    var contactNamespace = config.namespaces.contact;
    var xml = this.eppCommand(data, transactionId);
    return xml;
};
...
EPP.prototype.callConvert = function(eppData, root) {
    ...
    try {
        ...
        console.error("Caught an error while generating EPP: ", e);
    }
    return xml;
};
